...
std::string CP_DIR = "/home/siddarth/Siddarth/cp/";
std::string TEMPLATE_DIR = "/home/siddarth/Siddarth/cp/template/";
...
int main() {
  ...
  while (true) {
    ...
    // ========================JSON DATA: ========================
    // {"batch":{"id":"6c2dca08-b637-438a-9899-15a67582dc2b","size":1},"group":"Codeforces
    // - Codeforces Round 1011 (Div.
    // 2)","input":{"type":"stdin"},"interactive":false,"languages":{"java":{"mainClass":"Main","taskClass":"BServalAndFinalMEX"}},"memoryLimit":256,"name":"B.
    // Serval and Final
    // MEX","output":{"type":"stdout"},"testType":"single","tests":[{"input":"6\n4\n1
    // 2 3 4\n5\n0 1 0 0 1\n6\n0 0 0 0 0 0\n6\n5 4 3 2 1 0\n4\n0 0 1 1\n4\n1 0 0
    // 0\n","output":"1\n1 4\n4\n1 2\n1 2\n1 2\n1 2\n4\n5 6\n3 4\n1 2\n1 3\n3\n4
    // 5\n4 5\n1 4\n2\n1 2\n1 3\n2\n2 4\n1
    ...
    for (auto& test : j["tests"]) {
      ...
      std::string in_file_path =
          problem_dir_path + "sample" + std::to_string(i) + ".in";
      std::string out_file_path =
          problem_dir_path + "sample" + std::to_string(i) + ".out";
    ...
    std::cout << "Copied files from " << TEMPLATE_DIR << " to "
              << problem_dir_path << "\n\n";
  }
